...
namespace RestaurantBusiness
{
    public class clsProduct
    {
        ...
        public bool SaveProductAddOnSelections(List<int> AddOnIDs)
        {
            return clsProductsData.SaveProductAddOnSelections(this.ProductID, AddOnIDs);
        }
        public List<clsProductAddOnSelectionDTO> GetProductAddOnSelections()
        {
            return clsProductsData.GetProductAddOnSelections(this.ProductID);
        }
    }
}
