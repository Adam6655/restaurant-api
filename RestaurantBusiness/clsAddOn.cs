...
namespace RestaurantBusiness
{
    public class clsAddOn
    {
        ...
        {
            get { return (new clsAddOnDTO(this.AddOnID,this.AddOnName,this.Price,this.ImageURL,this.IsActive)); }
        }
        private clsAddOn(int AddOnid, string addOnName, decimal price, string imageURL, bool active)
        {
        ...
        public static clsAddOn Find(int ID)
        {
            ...
            if (AddOnDTO != null)
            {
                return new clsAddOn(ID,AddOnDTO.AddOnName,AddOnDTO.Price,AddOnDTO.ImageURL,AddOnDTO.IsActive);
            }
            else
                return null;
        }
        ...
        public bool SaveAddOnProductSelections(List<int> ProductIDs)
        {
            return clsAddOnsData.SaveAddOnProductSelections(this.AddOnID, ProductIDs);
        }
        public List<clsAddOnProductSelectionDTO> GetAddOnProductSelections()
        {
            return clsAddOnsData.GetAddOnProductSelections(this.AddOnID);
        }
    }
}
