...
namespace RestaurantData
{
    public class clsProductsData
    {
        ...
        public static bool SaveProductAddOnSelections(int ProductID, List<int> AddOnIDs)
        {
        ...
        public static List<clsProductAddOnSelectionDTO> GetProductAddOnSelections(int ProductID)
        {
            var ProductAddOnSelectionList = new List<clsProductAddOnSelectionDTO>();

            using (var connection = new SqlConnection(clsDataSettings.ConnectionString))
            using (var command = new SqlCommand("SP_GetProductAddOnSelections", connection))
            {
                command.CommandType = CommandType.StoredProcedure;
                ...
                using (var reader = command.ExecuteReader())
                {
                    ...
                    if (reader.Read())
                    {
                        ProductAddOnSelectionList.Add(new clsProductAddOnSelectionDTO
                        (
